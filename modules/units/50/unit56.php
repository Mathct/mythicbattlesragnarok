...
class unit56 extends unit
{
    ...
    public function onTiming($time, $attack)
    {
        ...
        {            
            $id = mythicbattlesragnarok::getUniqueValueFromDB( "SELECT id from unit where type=41");
            self::DbQuery( "DELETE FROM unit WHERE type=41");
        ...
        if($time == AFTERATTACKWOUND && $attack->from == $this && $attack->type == ATNORMAL)
        {
